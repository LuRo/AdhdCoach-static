...
export const ComplexitySummaryCard = ({ gaugeAngle, gaugeTransition, onRecalculate, snapshot, testId }: Props) => {
  ...
  return (
    <SummaryCard
      testId={testId ?? "morning-complexity-summary-card"}
      title={
      ...
      footer={
        <div className="d-flex align-items-center justify-content-between gap-2" style={{ marginTop: "-0.45rem" }}>
          <span className="small text-secondary">{t("Recommended threshold: 10 points")}</span>
          <CoachBadge className="px-3 py-1">
