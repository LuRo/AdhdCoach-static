    ...
    <div className="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3 mb-4">
      ...
      <div className="d-grid gap-2 min-w-0">
        <label className="d-grid gap-1">
          <span className="small text-secondary fw-semibold">Test date</span>
          <input
            type="date"
        ...
        <div className="small text-secondary">Plan and debrief data are stored locally for this date.</div>
      </div>
