...
const initialNotes = {
  ...
  fr: "La première remise à zéro a fonctionné une fois les messages fermés."
} as const;
...
const localeLabels = {
  ...
  fr: {
    ...
    answer: { yes_still_on_task: "oui, toujours sur la tâche", paused: "en pause", switched: "changé" },
