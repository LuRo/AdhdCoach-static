import { CoachBadge } from "../atoms/CoachBadge";
import { SectionCard } from "../atoms/SectionCard";
import type { ComplexitySnapshot } from "../../features/morning/types";
  ...
  <SectionCard className="px-3 py-3 px-md-4 d-flex align-items-center gap-3">
    <div className="flex-grow-1 complexity-card">
      <div className="d-flex justify-content-between align-items-center gap-2 mb-2">
        ...
        <CoachBadge tone={badgeTone(snapshot.status)}>{snapshot.status}</CoachBadge>
      </div>
      ...
      <div
        ...
        role="button"
        tabIndex={0}
        aria-label="Recalculate daily complexity gauge"
      ...
      <div className="d-flex align-items-center justify-content-between gap-2 mt-3">
        <span className="small text-secondary">Recommended threshold: 10 points</span>
        <CoachBadge className="px-3 py-2">{snapshot.total} points</CoachBadge>
      </div>
    </div>
  </SectionCard>
);
