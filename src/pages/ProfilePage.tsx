    ...
    <section className="section-panel active" id="profile-panel" aria-labelledby="profile-page-title" role="tabpanel" data-testid="profile-page">
      <div className="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3 mb-4">
        <div className="d-flex flex-column gap-2">
          ...
          <h1 id="profile-page-title" className="h2 mb-0">
            {copy.profile.title}
          </h1>
          <p className="text-secondary mb-0">{copy.profile.description}</p>
        </div>

        <CoachButton type="button" variant="outline" onClick={onClose} aria-label={copy.profile.closeAria} testId="profile-close-button">
          {copy.common.close}
        </CoachButton>
      </div>
